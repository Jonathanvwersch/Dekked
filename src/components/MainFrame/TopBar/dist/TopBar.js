...
var TopBar = function (_a) {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("div", { className: "dekked-topBarOuter" },
            react_1["default"].createElement("div", { className: "dekked-topBar" },
                !sidebar ? (react_1["default"].createElement("div", null,
                    react_1["default"].createElement(Icons.MdMenu, { className: "icon active hamburgerMenu", onClick: function () { handleSidebar(); setHoverbar(false); } }))) : null,
                react_1["default"].createElement("div", { className: "breadcrumbs" }, location.state ? (react_1["default"].createElement(react_1["default"].Fragment, null,
                    ...
                    location.state.type === "binder" ||
                        ...
                        location.state.type === "studySet" ? (react_1["default"].createElement(react_1["default"].Fragment, null,
                            ...
                            react_1["default"].createElement(react_router_dom_2.NavLink, { to: {
                                    ...
                                    state: {
                                        type: folderBlocks[location.state.folderIndex]
                                ...
                                react_1["default"].createElement(studyset_svg_1.ReactComponent, { className: "icon", stroke: folderBlocks[location.state.folderIndex].binders[location.state.binderIndex].studySets[location.state.studySetIndex]
                                        .iconColour }),
